 ...
 */
 ...
 ?>
    ...
    <footer class="text-muted mt-5 mb-5">
        <div class="container">
            <div>
                <small>Il codice di questo progetto è di provenienza open-sourced <a href="https://github.com/kenlog/coronavirusinfections.org">Github</a> con la licenza MIT.</small>
            </div>
            <div>
